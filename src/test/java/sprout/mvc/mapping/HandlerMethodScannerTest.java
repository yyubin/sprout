...
class HandlerMethodScannerTest {
    ...
    void setUp() {
        ...
        scanner = new HandlerMethodScanner(mockRegistry, mockPathPatternResolver);
    }
    ...
    void scanControllers_excludesNonHandlerMethods() throws NoSuchMethodException {
        ...
        when(beanFactory.getAllBeans())
                .thenReturn(Set.of(myController));
    ...
    void scanControllers_emptyPathsDefaultToRoot() throws NoSuchMethodException {
        ...
        when(beanFactory.getAllBeans()).thenReturn(beans);
